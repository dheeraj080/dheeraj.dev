  ...
  return (
    <div>
      ...
      <span className={clsx('text-slate-700', 'dark:text-slate-300')}>
        ...
        {/*
         */}
        <m.h1 className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
          ...
          dedicated to building robust,{' '}
          <span className="block text-slate-700 dark:text-slate-300">
            scalable infrastructures and seamless user experiences.
          </span>
        </m.h1>
      </span>
    </div>
