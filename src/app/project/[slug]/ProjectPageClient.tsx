...
const VISUALS: Record<string, React.FC> = {
  ...
  dheerajkamble: PortfolioVisuals,
};
      ...
      >
        ...
        <div style={{ position: "absolute", top: "3rem", left: "clamp(2rem, 6vw, 8rem)", display: "flex", alignItems: "center", gap: "2.5rem" }}>
          <button
            ...
            style={{ ...navBtnStyle, fontFamily: "var(--font-spacemono)", fontSize: "0.625rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#F3F4F6", opacity: 0.45 }}
          >
            ← BACK TO INDEX
          </button>
