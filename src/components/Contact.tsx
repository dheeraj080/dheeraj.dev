...
const LINKS = [
  { label: "GitHub", href: "https://github.com/dheerajkamble" },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/dheerajkamble/" },
  { label: "Twitter", href: "https://twitter.com/dheerajkamble" },
];
  ...
  return (
    <section ref={sectionRef} className="contact" id="contact">
      ...
      */}
      <a
        ref={emailRef}
        href="mailto:dheerajk1568@gmail.com"
        className="contact-email"
        aria-label="Send email to dheerajk1568@gmail.com"
      >
        dheerajk1568@gmail.com
      </a>
      ...
      <div
        style={{
          ...
          height: "1px",
          background:
            "linear-gradient(90deg, transparent 0%, #F97316 20%, #F97316 80%, transparent 100%)",
          opacity: 0.3,
          marginBottom: "3rem",
        }}
      />
      ...
      <div ref={footerRef} className="contact-footer">
        <p className="contact-footer-copy">
          © {new Date().getFullYear()} DHEERAJ KAMBLE — DHEERAJKAMBLE.COM
        </p>
        <p className="contact-footer-copy">
